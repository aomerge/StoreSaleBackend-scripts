...
CREATE TABLE sales (
    ...
    business_id  BIGINT NOT NULL, -- Corregido para coincidir con tu entidad
    ...
    CONSTRAINT FK_sales_business FOREIGN KEY (business_id) REFERENCES businesses(business_id),
